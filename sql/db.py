...
# query = "INSERT INTO salesman (salesman_id, name, city, commission, grade) " \
#         "VALUES (%s, %s, %s, %s, %s)"
# values = [
...
#
# print('======== TASK 3 =======')
# query = "SELECT name FROM salesman WHERE commission > 0.13"
# cursor.execute(query)
# print(cursor.fetchall())
#
# print('======== TASK 4 =======')
...
#
# print('======== TASK 6 =======')
# query = "SELECT name FROM salesman WHERE commission=(SELECT MAX(commission) from salesman)"
# cursor.execute(query)
# print(cursor.fetchall())
#
# print('======== TASK 7 =======')
# query = "SELECT name FROM salesman WHERE commission=(SELECT MIN(commission) from salesman)"
# cursor.execute(query)
# print(cursor.fetchall())